...
| ---------- | ---------------- | ----------- | ------------------- | ------------------ |
| 2026-09-03 | `main @ a9cde1c` | 4,410 lines | 283 across 16 files | apimatic-cli 1.3.1 |
...
| `telemetry.ts` · the POST                                                         | `infrastructure/mixpanel-client.ts`                                                                   | infra               |                                                                                                                                                                                       |
...
- The four event classes; commands fire them from reports; `deps.track`, `sinkOf`,
  `trackFailure` and the `Deps` type are deleted. A test asserts the flushed payload for
  install, failed install, uninstall and failed uninstall equals today's.

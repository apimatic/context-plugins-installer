...
/** The object form of a registry entry. `source` may point at another repository. */
 ...
 * across CLI versions, so everything is optional and extra fields are legal;
 * repoOf() probes the known spellings and falls back to a full-text search.
 */
export interface MarketplaceListing {
  name?: string;
  repo?: string;
  url?: string;
  source?: string | { repo?: string; url?: string; [key: string]: unknown };
  [key: string]: unknown;
}

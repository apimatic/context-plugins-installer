...
export const COLLECTED =
  'the plugin id when the plugin came from a marketplace - one installed from a path, a ' +
  'repository or an archive is named by its own author, and that name stays on this machine - ' +
  'the editor it went into, whether the plugin came from a marketplace, a GitHub repository, ' +
  'a directory or an archive (never the path, the repository or the URL itself), ' +

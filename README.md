...
| `Nothing was installed - cleared the stale record`                        | The record claimed an assistant that no longer had the plugin (removed by hand, or renamed upstream). The record is now correct. |
